...
export default function NuevaZonaPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setSaving(true);
            await pb.collection('zonas_geofencing').create({
                nombre,
                activo,
                es_templo,
                geojson
            ...
            setError('Ocurrió un error al guardar la zona.');
            setSaving(false);
        }
    };
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-foreground">Nueva Zona Geofencing</h1>
                    <p className="text-sm text-muted-foreground mt-1">
                        Crea un nuevo polígono en el mapa
                    </p>
                </div>
            </div>
            ...
            <Card className="shadow-md border-border/50">
                <CardHeader className="bg-muted/10 border-b border-border/50 pb-4">
                    ...
                    <CardDescription>
                        Rellena los datos básicos y dibuja el área en el mapa.
                    </CardDescription>
                </CardHeader>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-3 pt-2">
                            <label className="text-sm font-semibold text-foreground flex items-center justify-between">
                                <span>Dibujar el Polígono</span>
                                <span className="text-xs font-normal text-muted-foreground px-2 py-1 bg-muted rounded">Usa la herramienta del cuadrado/polígono a la derecha</span>
                            </label>
